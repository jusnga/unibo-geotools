...
public class SrtmElevationAPITest {
	...
	public SrtmElevationAPITest() {
		File localDir = new File("/home/mone/Documenti/Università/Elevation/paparazzi/srtm");
	...
	public void testGetElevationsString() throws Exception {
		...
		assertTrue("fails on max:" + max, (max > 565) && (max < 570));
	}
